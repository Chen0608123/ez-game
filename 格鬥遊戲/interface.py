...
def main():
    ...
    pygame.display.set_caption("介面介紹")
    font = pygame.font.SysFont('microsoftjhenghei', 24)

    interface_img = pygame.image.load("inside\interface.png")
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_BACKSPACE:  # 按下 Backspace 返回主畫面
                    ...
                    pygame.quit()
                    subprocess.run(["python", "common.py"])  # 執行 common.py
                    sys.exit()
        ...
        help_text = font.render("按 Backspace 返回主畫面，按 Enter 繼續 ", True, WHITE)
